...
#if __CH_VERSION_HOLDALL_H__ != 202501L
#error Bad 'holdall' version.
#else

//  struct holdall, holdall : gestion des adresses des objets dans le fourretout
//    à l'aide d'une liste dynamique simplement chainée. Le composant head a
//    pour valeur le pointeur de tête de la liste, le composant count mémorise
//    la longueur de la liste. Si la macroconstante HOLDALL_PUT_TAIL n'est pas
//    définie, l'insertion d'une adresse a lieu en tête. Si la macroconstante
//    HOLDALL_PUT_TAIL est définie, l'insertion a lieu en queue et le composant
//    composant tailptr mémorise l'adresse du seul pointeur de chainage de la
//    liste dynamique simplement chainée dont la valeur est un pointeur nul.
